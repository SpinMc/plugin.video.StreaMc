...
REMOTE_VERSION_FILE = "https://raw.githubusercontent.com/SpinMc/plugin.video.StreaMc/master/version.xml"
REMOTE_FILE = "https://github.com/SpinMc/plugin.video.StreaMc/releases/download/plugin.video.StreaMc-v%s/plugin.video.StreaMc-v%s.zip"
...
def download_and_install(remote_file_name, local_file_name):
    ...
    path_channels=xbmc.translatePath("special://home/addons/plugin.video.StreaMc/channels")
    filetools.rmdirtree(path_channels)
    path_servers=xbmc.translatePath("special://home/addons/plugin.video.StreaMc/servers")
